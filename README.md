...
Details are shown in the ![attached schema:](https://github.com/annagreenford/Sales_Database_design_project_rep/tree/main/SalesInventoryDB-schema.png "Image of database schema"). 
